...
class _BankVideoState extends State<BankVideo> {
  ...
  final String url = 'assets/videos/bank_REV.mp4';

  final String motorVideo = 'assets/videos/bank_MOTOR.mp4';
  final String energySavingVideo = 'assets/videos/bank_MOTOR.mp4';
  final String mapVideo = 'assets/videos/bank_MAP.mp4';
