...
class _DataCentreVideoState extends State<DataCentreVideo> {
  ...
  final String url = 'assets/videos/datacentre_REV.mp4';

  final String motorVideo = 'assets/videos/datacentre_MOTOR.mp4';
  final String energySavingVideo = 'assets/videos/datacentre_MOTOR.mp4';
  final String mapVideo = 'assets/videos/datacentre_MAP.mp4';
