...
class _FastFoodVideoState extends State<FastFoodVideo> {
  ...
  final String url = 'assets/videos/fastfood_REV.mp4';

  final String motorVideo = 'assets/videos/fastfood_MOTOR.mp4';
  final String energySavingVideo = 'assets/videos/fastfood_MOTOR.mp4';
  final String mapVideo = 'assets/videos/fastfood_MAP.mp4';
