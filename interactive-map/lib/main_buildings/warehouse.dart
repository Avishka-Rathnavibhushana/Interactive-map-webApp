...
class _WarehouseVideoState extends State<WarehouseVideo> {
  ...
  final String url = 'assets/videos/warehouse_REV.mp4';

  final String motorVideo = 'assets/videos/warehouse_MOTOR.mp4';
  final String energySavingVideo = 'assets/videos/warehouse_MOTOR.mp4';
  final String mapVideo = 'assets/videos/warehouse_MAP.mp4';
