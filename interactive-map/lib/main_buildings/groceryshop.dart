...
class _GroceryShopVideoState extends State<GroceryShopVideo> {
  ...
  final String url = 'assets/videos/groceryshop_REV.mp4';

  final String motorVideo = 'assets/videos/groceryshop_MOTOR.mp4';
  final String energySavingVideo = 'assets/videos/groceryshop_MOTOR.mp4';
  final String mapVideo = 'assets/videos/groceryshop_MAP.mp4';
